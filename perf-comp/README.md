$\color{blue}{\text{The proposed model, implemented in PyTorch, offers greater memory efficiency and faster training than TensorFlow when solving 2D PDEs, as demonstrated below.
